...
for i in range(25):
    panel.appendBoard("../cryptostick.kicad_pcb", wxPointMM(10+21.775/2, 10+16.275/2+i*16.275), sourceArea=None, origin=Origin.Center, 
            rotationAngle=fromDegrees(180), shrink=False, tolerance=fromMm(25), bufferOutline=1000, 
            netRenamer=None, refRenamer=None)
    panel.appendBoard("../cryptostick.kicad_pcb", wxPointMM(10+21.775/2+21.775, 10+16.275/2+i*16.275), sourceArea=None, origin=Origin.Center, 
            rotationAngle=fromDegrees(0), shrink=False, tolerance=fromMm(25), bufferOutline=1000, 
            netRenamer=None, refRenamer=None)
    panel.appendBoard("../cryptostick.kicad_pcb", wxPointMM(10+21.775/2+2*21.775, 10+16.275/2+i*16.275), sourceArea=None, origin=Origin.Center, 
            rotationAngle=fromDegrees(180), shrink=False, tolerance=fromMm(25), bufferOutline=1000, 
            netRenamer=None, refRenamer=None)
    panel.appendBoard("../cryptostick.kicad_pcb", wxPointMM(10+21.775/2+3*21.775, 10+16.275/2+i*16.275), sourceArea=None, origin=Origin.Center, 
            rotationAngle=fromDegrees(0), shrink=False, tolerance=fromMm(25), bufferOutline=1000, 
            netRenamer=None, refRenamer=None)
